...
export const frontend = [
  ...
  },
  {
    ...
    image: "/portfolio.jpg",
    description:
      "This is my portfolio website built on next.js and hosted on Vercel.",
  },
];
  ...
  return (
    <main>
                  ...
                  <div>
                    <Link href={project.github} target="_blank">
                      <Image
                        ...
                        alt="github-icon"
                      />
                      <span style={{ padding: 10, fontWeight: 600 }}>
                        Github
                      </span>
                    </Link>
                  </div>
      ...
      <section className={styles.backend}>
        <div className={styles.sectionHeader} id="backend">
          {" "}
          Backend Projects
        </div>
        <section className={styles.sectionBody}>
